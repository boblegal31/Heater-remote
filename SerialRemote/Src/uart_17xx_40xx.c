...
STATIC void Chip_UART_ABIntHandler(LPC_UART_TypeDef *pUART)
{
...
void Chip_UART_ABCmd(LPC_UART_TypeDef *pUART, uint32_t mode, bool autorestart, FunctionalState NewState)
{
    uint32_t tmp = 0;
