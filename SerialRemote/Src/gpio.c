...
#if 0
  LPC_IOCON->R_PIO1_0 = 0x91;
  LPC_IOCON->R_PIO1_1 = 0x91;
  LPC_IOCON->R_PIO1_2 = 0x91;
  LPC_IOCON->SWDIO_PIO1_3 = 0x91;
#else
  LPC_IOCON->R_PIO1_0 = 0x90;
  LPC_IOCON->R_PIO1_1 = 0x90;
  LPC_IOCON->R_PIO1_2 = 0x90;
  LPC_IOCON->SWDIO_PIO1_3 = 0x90;
#endif
...
**
*****************************************************************************/
void GPIO1SetValue(uint32_t bitVal )
{
	LPC_GPIO1->DATA = bitVal;
