 ...
 */
STATIC INLINE void Chip_UART_SendByte(LPC_UART_TypeDef *pUART, uint8_t data)
{
 ...
 */
STATIC INLINE uint8_t Chip_UART_ReadByte(LPC_UART_TypeDef *pUART)
{
 ...
 */
STATIC INLINE void Chip_UART_IntEnable(LPC_UART_TypeDef *pUART, uint32_t intMask)
{
	pUART->IER |= intMask;
}
 ...
 *			This function doesn't alter the DLAB state
 */
STATIC INLINE void Chip_UART_IntDisable(LPC_UART_TypeDef *pUART, uint32_t intMask)
{
	pUART->IER &= ~intMask;
}
 ...
 */
STATIC INLINE uint32_t Chip_UART_GetIntsEnabled(LPC_UART_TypeDef *pUART)
{
	return pUART->IER;
}
 ...
 */
STATIC INLINE uint32_t Chip_UART_ReadIntIDReg(LPC_UART_TypeDef *pUART)
{
	return pUART->IIR;
}
 ...
 */
STATIC INLINE void Chip_UART_SetupFIFOS(LPC_UART_TypeDef *pUART, uint32_t fcr)
{
	pUART->FCR = fcr;
}
 ...
 */
STATIC INLINE void Chip_UART_ConfigData(LPC_UART_TypeDef *pUART, uint32_t config)
{
	pUART->LCR = config;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_UART_EnableDivisorAccess(LPC_UART_TypeDef *pUART)
{
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_UART_DisableDivisorAccess(LPC_UART_TypeDef *pUART)
{
	pUART->LCR &= ~UART_LCR_DLAB_EN;
}
 ...
 */
STATIC INLINE void Chip_UART_SetDivisorLatches(LPC_UART_TypeDef *pUART, uint8_t dll, uint8_t dlm)
{
 ...
 */
STATIC INLINE uint32_t Chip_UART_ReadModemControl(LPC_UART_TypeDef *pUART)
{
	return pUART->MCR;
}
 ...
 */
STATIC INLINE void Chip_UART_SetModemControl(LPC_UART_TypeDef *pUART, uint32_t mcr)
{
	pUART->MCR |= mcr;
}
 ...
 */
STATIC INLINE void Chip_UART_ClearModemControl(LPC_UART_TypeDef *pUART, uint32_t mcr)
{
	pUART->MCR &= ~mcr;
}
 ...
 *			definitions for specific statuses.
 */
STATIC INLINE uint32_t Chip_UART_ReadLineStatus(LPC_UART_TypeDef *pUART)
{
	return pUART->LSR;
}
 ...
 *			definitions for specific statuses.
 */
STATIC INLINE uint32_t Chip_UART_ReadModemStatus(LPC_UART_TypeDef *pUART)
{
	return pUART->MSR;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_UART_SetScratch(LPC_UART_TypeDef *pUART, uint8_t data)
{
 ...
 */
STATIC INLINE uint8_t Chip_UART_ReadScratch(LPC_UART_TypeDef *pUART)
{
 ...
 *			call to set specific options.
 */
STATIC INLINE void Chip_UART_SetAutoBaudReg(LPC_UART_TypeDef *pUART, uint32_t acr)
{
	pUART->ACR |= acr;
}
 ...
 *			call to clear specific options.
 */
STATIC INLINE void Chip_UART_ClearAutoBaudReg(LPC_UART_TypeDef *pUART, uint32_t acr)
{
	pUART->ACR &= ~acr;
}
#ifdef NOT_USED
 ...
 *			call to set specific options.
 */
STATIC INLINE void Chip_UART_SetRS485Flags(LPC_UART_TypeDef *pUART, uint32_t ctrl)
{
 ...
 *			call to clear specific options.
 */
STATIC INLINE void Chip_UART_ClearRS485Flags(LPC_UART_TypeDef *pUART, uint32_t ctrl)
{
	pUART->RS485CTRL &= ~ctrl;
}
 ...
 * @return	Nothing
 */
STATIC INLINE void Chip_UART_SetRS485Addr(LPC_UART_TypeDef *pUART, uint8_t addr)
{
 ...
 */
STATIC INLINE uint8_t Chip_UART_GetRS485Addr(LPC_UART_TypeDef *pUART)
{
 ...
 */
STATIC INLINE void Chip_UART_SetRS485Delay(LPC_UART_TypeDef *pUART, uint8_t dly)
{
 ...
 *			time from 0 to 255 bit times may be programmed.
 */
STATIC INLINE uint8_t Chip_UART_GetRS485Delay(LPC_UART_TypeDef *pUART)
{
 ...
 * @return	Nothing
 */
void Chip_UART_Init(LPC_UART_TypeDef *pUART);
 ...
 * @return	Nothing
 */
void Chip_UART_DeInit(LPC_UART_TypeDef *pUART);
 ...
 * @return Nothing
 */
void Chip_UART_TXEnable(LPC_UART_TypeDef *pUART);
 ...
 * @return Nothing
 */
void Chip_UART_TXDisable(LPC_UART_TypeDef *pUART);
 ...
 */
FlagStatus Chip_UART_CheckBusy(LPC_UART_TypeDef *pUART);
 ...
 */
int Chip_UART_Send(LPC_UART_TypeDef *pUART, const void *data, int numBytes);
 ...
 */
int Chip_UART_Read(LPC_UART_TypeDef *pUART, void *data, int numBytes);
 ...
 * @return	The actual baud rate, or 0 if no rate can be found
 */
uint32_t Chip_UART_SetBaudFDR(LPC_UART_TypeDef *pUART, uint32_t baudrate);
 ...
 */
int Chip_UART_SendBlocking(LPC_UART_TypeDef *pUART, const void *data, int numBytes);
 ...
 */
int Chip_UART_ReadBlocking(LPC_UART_TypeDef *pUART, void *data, int numBytes);
 ...
 */
void Chip_UART_RXIntHandlerRB(LPC_UART_TypeDef *pUART, RINGBUFF_T *pRB);
 ...
 */
void Chip_UART_TXIntHandlerRB(LPC_UART_TypeDef *pUART, RINGBUFF_T *pRB);
 ...
 */
uint32_t Chip_UART_SendRB(LPC_UART_TypeDef *pUART, RINGBUFF_T *pRB, const void *data, int bytes);
 ...
 */
int Chip_UART_ReadRB(LPC_UART_TypeDef *pUART, RINGBUFF_T *pRB, void *data, int bytes);
 ...
 */
void Chip_UART_IRQRBHandler(LPC_UART_TypeDef *pUART, RINGBUFF_T *pRXRB, RINGBUFF_T *pTXRB);
 ...
 */
FlagStatus Chip_UART_GetABEOStatus(LPC_UART_TypeDef *pUART);
 ...
 * @return	Nothing
 */
void Chip_UART_ABCmd(LPC_UART_TypeDef *pUART, uint32_t mode, bool autorestart,
