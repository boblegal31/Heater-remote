...
#include "usbd_13xx.h"                        /* LPC13xx definitions */
#include "usb.h"
#include "usbcfg.h"
#include "usbreg.h"
#include "usbhw.h"
...
{
  Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO0_1, IOCON_FUNC1);
  Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO0_3, IOCON_FUNC1);
  Chip_IOCON_PinMuxSet(LPC_IOCON, IOCON_PIO0_6, MD_PUP | IOCON_FUNC1);
